...
public class Course测试类 {
    ...
    /* 读入TXT文件 */
        public static List<Course> readTxt() throws Exception{
            ...
            String pathname = Course测试类.class.getResource("/").toString();
            pathname = pathname.substring(6, pathname.length()-4)+("D:/develop/JetBrains/代码案例/untitled/src/class.txt"); //获取绝对路径
